...
1. `${CLAUDE_SKILL_DIR}/../../docs/red_team_protocol.md` (the canonical protocol, with question sets per phase and per lens)
2. `${CLAUDE_SKILL_DIR}/../../docs/principles_and_antipatterns.md` (the cognitive bias watchlist that the protocol implements)
