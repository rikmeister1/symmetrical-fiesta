...
1. `${CLAUDE_SKILL_DIR}/../../docs/orchestrator.md`
2. `${CLAUDE_SKILL_DIR}/../../docs/innovation_canvas_document.md`
3. `${CLAUDE_SKILL_DIR}/../../docs/trl_specification.md`
...
3. **File availability:** Since Claude Code has file system access, verify that the referenced docs exist in `${CLAUDE_SKILL_DIR}/../../docs/`. Inform the user if any are missing.
