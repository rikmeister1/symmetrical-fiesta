...
1. `.claude/docs/innovation_canvas_document.md` (source of record for ICD section semantics)
2. `.claude/docs/executive_summary_template.md` (the two-page exec summary template, used by the `summary` action)
3. `.claude/docs/trl_specification.md` (only when the export needs TRL labels)
